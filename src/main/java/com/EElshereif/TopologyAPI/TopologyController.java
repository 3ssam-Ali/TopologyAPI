...
public class TopologyController {
    ...
    public static void loadTopology(String filename){
        ...
        try {
            ...
            throw new RuntimeException("Error Loading the FIle, File Name is Probably Incorrect or i doesn't exist");
        }
        catch (IOException e) {
            throw new RuntimeException("Topology File is corrupted");
        }
    }
